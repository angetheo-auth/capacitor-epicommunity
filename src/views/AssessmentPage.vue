...
import { ref } from "vue";
import { IonPage, IonMenuButton, IonHeader, IonSegment, IonSegmentButton, IonToolbar, IonTitle, IonContent, IonButton, IonButtons, IonActionSheet, IonItem, IonInput, IonTextarea, IonGrid, IonRow, IonCol, IonSelect, IonSelectOption, IonLabel, IonChip, IonIcon, IonAvatar, IonCard, IonCardHeader, IonCardContent, IonCardTitle, IonModal } from "@ionic/vue";
import { searchOutline, notificationsOutline, bookOutline, businessOutline, bulbOutline, libraryOutline } from "ionicons/icons";
...
const criteria = ref<CriteriaItem[]>([
  {
    ...
    description:
      "Ability for critical analysis, evaluation and synthesis of new and complex ideas;  to conducts research under supervision or independently to advances a research agenda and to take the lead in executing collaborative research projects. Development of a strategic vision on the future of the research field and contribute through original research by developing a substantial body of work, innovation or application.",
    comment: "",
    rating: "1",
  },
  {
  ...
  },
  {
    ...
    description:
      "Contribute and engage in collaborative, team-based reserach and share tasks and responsibilities equally among all team members and empower and support young researchers",
    comment: "",
    rating: "1",
  },
]);
