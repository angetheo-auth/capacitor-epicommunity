      ...
      <ion-grid>
        <ion-row>
          <ion-col size="12" size-md="8">
            ...
            <ion-input value="Publication #1 Title"></ion-input>

            <ion-label>Publication Description</ion-label>
            <ion-textarea value="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quibusdam consequuntur cupiditate provident."></ion-textarea>
        
            <ion-label>Published Year</ion-label>
            <ion-input value="2025"></ion-input>

            <ion-label>Publication Link</ion-label>
            <ion-input value="http://publication.com"></ion-input>

            <ion-label>Publication Logo</ion-label>
          ...
          <ion-col size="12" size-md="4">
            <ion-card>
              <ion-card-content>
                ...
                <ion-toggle class="ion-padding"></ion-toggle>
