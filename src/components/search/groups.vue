...
<script setup>
import { IonButton, IonIcon, IonRow, IonGrid, IonCol, IonCard, IonCardContent, IonCardHeader, IonLabel, IonItem, IonChip, IonSelect, IonSelectOption, IonInput, IonButtons } from "@ionic/vue";
