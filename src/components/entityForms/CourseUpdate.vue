      ...
      <ion-grid>
        <ion-row>
          <ion-col>
            ...
            <ion-input value="Course Title 1"></ion-input>
            ...
            <ion-row>
              <ion-col>
                <ion-label>Course Link</ion-label>
                <ion-input value="http://course#1.url"></ion-input>
              </ion-col>
            </ion-row>
            <ion-row>
            ...
            <ion-label>Course Logo</ion-label>
          ...
          <ion-col size="12" size-md="4">
            <ion-card>
              <ion-card-content>
                <ion-label>Offered By</ion-label>
